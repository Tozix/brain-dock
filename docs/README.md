...
> **📘 [GUIDE.md](GUIDE.md) — полное руководство:** локальный и удалённый деплой, выпуск API-ключа,
> индексация кода, подключение Claude Code/Cursor к удалённому MCP, справочник инструментов.
